...
public static class SqlServerTableBuilderExtensions
{
        ...
        bool temporal = true)
    {
        ...
        return new OwnedNavigationTemporalTableBuilder(tableBuilder.ReferenceOwnershipBuilder);
    }
        ...
        Action<OwnedNavigationTemporalTableBuilder> buildAction)
    {
        ...
        buildAction(new OwnedNavigationTemporalTableBuilder(tableBuilder.ReferenceOwnershipBuilder));
        ...
        where TEntity : class
    {
        ...
        return new OwnedNavigationTemporalTableBuilder<TEntity>(tableBuilder.ReferenceOwnershipBuilder);
    }
    ...
    {
        tableBuilder.Metadata.SetIsTemporal(true);
        buildAction(new OwnedNavigationTemporalTableBuilder<TEntity>(tableBuilder.ReferenceOwnershipBuilder));
