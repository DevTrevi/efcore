...
public class OwnedNavigationTemporalTableBuilder
{
    ...
    public virtual OwnedNavigationTemporalPeriodPropertyBuilder HasPeriodStart(string propertyName)
    {
        ...
        return new OwnedNavigationTemporalPeriodPropertyBuilder(_referenceOwnershipBuilder, propertyName);
    }
    ...
    {
        var property = _referenceOwnershipBuilder.Property(typeof(DateTime), propertyName, setTypeConfigurationSource: false);
